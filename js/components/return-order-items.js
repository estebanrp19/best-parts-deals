const returnOrderItem = (data) => {
    const template =
        ...
        '<td><button class="trn btn btn-add-delete btn-outline-primary" data-trn-key="return_item_btn" id="btn-return-item-' + data.orderId + '-' + data.itemCode + '">Return item</button></td>' +
        '</tr>'
